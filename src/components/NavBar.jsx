    ...
    <>
      ...
      >
        <div className="inner">
          ...
          >
            <span className="inline-block transition-all duration-300 hover:scale-105" style={{ color: "var(--text-primary)" }}>
              Porto
            </span>
            <span className="inline-block transition-all duration-300 hover:scale-105" style={{ color: "var(--accent)" }}>
              folio
            </span>
          </a>
      ...
      >
        <div className="flex flex-col h-full p-8 pt-24">
          ...
          <div className="mb-8">
            <a
              className="text-2xl font-bold inline-block transition-all duration-300 hover:scale-105"
              style={{ color: 'var(--text-primary)' }}
              href="#hero"
              onClick={handleNavClick}
            >
              <span style={{ color: 'var(--text-primary)' }}>Porto</span>
          ...
          >
            <a
              ...
              aria-label="GitHub"
            >
              <svg className="w-5 h-5 transition-colors" style={{ color: 'var(--text-secondary)' }} fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="mailto:akramraton4@gmail.com" className="p-3 backdrop-blur-sm rounded-lg transition-all duration-300" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-primary)' }} aria-label="Email">
