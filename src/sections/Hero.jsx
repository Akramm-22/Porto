...
const Hero = () => {
  ...
  const socialLinks = [
    {
      href: "https://github.com/Akramm-22",
      label: "GitHub",
    ...
    {
      href: "https://www.linkedin.com/in/akram-mujjaman-raton-6103453ba/",
      label: "LinkedIn",
      path: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z",
    },
    {
      href: "mailto:akramraton4@gmail.com",
      label: "Email",
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center px-5 md:px-10 lg:px-20 gap-10 md:gap-14">
        ...
        <figure className="w-full md:w-1/2 flex items-center justify-center md:order-2">
          <div className="hero-profile relative flex flex-col items-center gap-5 w-full max-w-[360px]">
            <img
              src="/images/2x2.jpg"
              alt="Foto profil Akram Mujjaman Raton"
              width={440}
              height={440}
...
Akram Mujjaman Raton — Front-End Developer
                </span>
                <br />
                <span style={{ color: "var(--accent)" }}>$</span> status
                <br />
                {">"} <span style={{ color: "var(--accent)" }}>● open to roles</span> · front-end development
              </div>
            </div>
          </div>
        </figure>
        ...
        <header className="w-full md:w-1/2 flex flex-col justify-center md:order-1">
          <div className="flex flex-col gap-5">
            <span className="chip w-fit">
              ...
              Terbuka untuk posisi Front-End
            </span>
...
Front-End Developer
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
Siswa SMK yang berdedikasi dan aktif berkontribusi di bidang teknologi. Berpengalaman mengembangkan berbagai platform berbasis web untuk kebutuhan pembelajaran maupun kebutuhan klien eksternal. Memiliki kemampuan pemecahan masalah yang kuat, adaptif, serta mampu memberikan solusi yang efisien dan efektif. Aktif berpartisipasi dalam kompetisi, organisasi, dan pengembangan skill secara berkelanjutan untuk meningkatkan keahlian teknis sekaligus pengalaman profesional.
            </p>
...
Lihat Proyek
            ...
            <p className="font-mono text-xs pt-2" style={{ color: "var(--text-tertiary)" }}>
              Front-End & Web Development · Laravel · Next.js · Git
            </p>
          </div>
        </header>
      </div>
